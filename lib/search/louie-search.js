...
(function () {
  ...
  async function loadRemote() {
    ...
    /* learn courses — single source of truth is learn's own manifest.js
       (window.__LEARN_MANIFEST). On learn it's already loaded; elsewhere
       fetch the file and evaluate it against a sandbox object. */
    try {
    ...
    } catch (e) { /* learn unreachable — skip courses */ }
