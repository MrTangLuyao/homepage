(function (global, factory) {
	...
	var _picocInst=null;
	function _picocInit(){
	  if(_picocInst)return Promise.resolve(_picocInst);
	  return new Promise(function(resolve){
	    var pc=picoc();
	    pc.onRuntimeInitialized=function(){_picocInst=pc;resolve(pc);};
	  });
	}
	function runC(cprog,consoleWrite){
	  return _picocInit().then(function(pc){
	    var out='';
	    pc.runc(cprog,consoleWrite||function(s){out+=(s||'');});
	    return out;
	  });
	}

	exports.runC = runC;
	exports.initPicoc = _picocInit;
